...
namespace com.strava.api.Client
{
    ...
    public class EffortClient : BaseClient
    {
        ...
        /// <param name="before">The date before all the efforts have been recorded.</param>
        /// <returns>A list of segment efforts</returns>
        public async Task<List<SegmentEffort>> GetSegmentEffortsByTime(String segmentId, DateTime after, DateTime before)
        {
            List<SegmentEffort> activities = new List<SegmentEffort>();
            int page = 1;
            bool hasEntries = true;
            ...
            while (hasEntries)
            {
                List<SegmentEffort> request = await GetSegmentEffortsByTime(segmentId, after, before, page++, 200);
        ...
        /// <param name="perPage">The number of results shown per page.</param>
        /// <returns>A list of segment efforts</returns>
        public async Task<List<SegmentEffort>> GetSegmentEffortsByTime(String segmentId, DateTime after, DateTime before, int page, int perPage)
        {
            String getUrl = String.Format("{0}/{1}/all_efforts?start_date_local={2}&end_date_local={3}&page={4}&per_page={5}&access_token={6}",
                Endpoints.Leaderboard,
                segmentId,
        ...
        /// <param name="athleteId">The Strava athlete id.</param>
        /// <returns>A list of efforts from the athlete on the specified segment.</returns>
        public async Task<List<SegmentEffort>> GetSegmentEffortsByAthlete(String segmentId, String athleteId)
        {
            List<SegmentEffort> activities = new List<SegmentEffort>();
            int page = 1;
            bool hasEntries = true;
            ...
            while (hasEntries)
            {
                List<SegmentEffort> request = await GetSegmentEffortsByAthlete(segmentId, athleteId, page++, 200);
        ...
        /// <param name="perPage">The number of results shown per page.</param>
        /// <returns>A list of efforts from the athlete on the specified segment.</returns>
        public async Task<List<SegmentEffort>> GetSegmentEffortsByAthlete(String segmentId, String athleteId, int page, int perPage)
        {
            String getUrl = String.Format("{0}/{1}/all_efforts?athlete_id={2}&page={3}&per_page={4}&access_token={5}",
                Endpoints.Leaderboard,
                segmentId,
        ...
        /// <param name="before">The date before all the efforts have been recorded.</param>
        /// <returns>A list of efforts from the athlete on the specified segment.</returns>
        public async Task<List<SegmentEffort>> GetSegmentEfforts(String segmentId, String athleteId, DateTime after, DateTime before)
        {
            List<SegmentEffort> activities = new List<SegmentEffort>();
            int page = 1;
            bool hasEntries = true;
            ...
            while (hasEntries)
            {
                List<SegmentEffort> request = await GetSegmentEfforts(segmentId, athleteId, after, before, page++, 200);
        ...
        /// <param name="perPage">The number of results shown per page.</param>
        /// <returns>A list of efforts from the athlete on the specified segment.</returns>
        public async Task<List<SegmentEffort>> GetSegmentEfforts(String segmentId, String athleteId, DateTime after, DateTime before, int page, int perPage)
        {
            String getUrl = String.Format("{0}/{1}/all_efforts?athlete_id={2}&start_date_local={3}&end_date_local={4}&page={5}per_page={6}&access_token={7}",
                Endpoints.Leaderboard,
                segmentId,
        ...
        /// <param name="segmentId">The Strava segment id.</param> 
        /// <returns>A list of efforts from the athlete on the specified segment.</returns>
        public async Task<List<SegmentEffort>> GetSegmentEfforts(String segmentId)
        {
            List<SegmentEffort> activities = new List<SegmentEffort>();
            int page = 1;
            bool hasEntries = true;
            ...
            while (hasEntries)
            {
                List<SegmentEffort> request = await GetSegmentEfforts(segmentId, page++, 200);
        ...
        /// <param name="perPage">The number of results shown per page.</param>
        /// <returns>A list of efforts from the athlete on the specified segment.</returns>
        public async Task<List<SegmentEffort>> GetSegmentEfforts(String segmentId, int page, int perPage)
        {
            String getUrl = String.Format("{0}/{1}/all_efforts?page={2}per_page={3}&access_token={4}",
                Endpoints.Leaderboard,
                segmentId,
